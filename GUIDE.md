...
> **Welcome to Service-Track Week 8, Hotfix 1!**
...
1. **Read the comments** at the top of `cronScheduler.py` - they describe the problem
...
| File | Purpose |
|------|---------|
| `cronScheduler.py` | The code with bugs - **fix this file** |
...
### Bug #1
**User Report / Alert:**
> "No check if job is already running â€” causes overlapping execution"
...
### Bug #2
**User Report / Alert:**
> "No timeout enforcement â€” stuck job runs forever"
...
### Bug #3
**User Report / Alert:**
> "Error silently swallowed â€” no alerting"
...
### Bug #4
**User Report / Alert:**
> "Not implemented â€” returns empty list"
...
1. **Read the top comment block** in `cronScheduler.py` carefully - it has:
